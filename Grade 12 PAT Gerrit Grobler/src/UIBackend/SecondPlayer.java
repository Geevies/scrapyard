...
public class SecondPlayer {
    ...
    public SecondPlayer(int vertical, int horizontal, int rotation, int health) {
    ...
    public void spriteJill() {
        switch (rotation) {
            case 1:
                jill.removeAll();
                JLabel spriteContainer = new JLabel(new ImageIcon("src/tankjpg/jpgOldie/redJillup.png"));
            ...
            case 2:
                jill.removeAll();
                spriteContainer = new JLabel(new ImageIcon("src/tankjpg/jpgOldie/redJillright.png"));
            ...
            case 3:
                jill.removeAll();
                spriteContainer = new JLabel(new ImageIcon("src/tankjpg/jpgOldie/redJilldown.png"));
                spriteContainer.setPreferredSize(new Dimension(53, 68));
                jill.setPreferredSize(new Dimension(53, 68));
                spriteContainer.setVisible(true);
                jill.add(spriteContainer);
            ...
            case 4:
                jill.removeAll();
                spriteContainer = new JLabel(new ImageIcon("src/tankjpg/jpgOldie/redJillleft.png"));
                spriteContainer.setPreferredSize(new Dimension(64, 60));
                jill.setPreferredSize(new Dimension(64, 60));
                spriteContainer.setVisible(true);
                jill.add(spriteContainer);
    ...
    public void loseHealth() {
        health--;
        if (health == 0) {
            main.main.GameOver(ProfileScreen.getPlayer1(), FirstPlayer.getHealth());
        }
    }
}