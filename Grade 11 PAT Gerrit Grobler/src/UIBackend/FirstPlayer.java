...
public class FirstPlayer {
    ...
    public FirstPlayer(int vertical, int horizontal, int rotation) {
    ...
    public void spriteBob() {
        switch (rotation) {
            case 1:
                bob.removeAll();
                JLabel spriteContainer = new JLabel(new ImageIcon("src/tankjpg/blueBobup.png"));
            ...
            case 2:
                bob.removeAll();
                spriteContainer = new JLabel(new ImageIcon("src/tankjpg/blueBobright.png"));
            ...
            case 3:
                bob.removeAll();
                spriteContainer = new JLabel(new ImageIcon("src/tankjpg/blueBobdown.png"));
                spriteContainer.setPreferredSize(new Dimension(53, 68));
                bob.setPreferredSize(new Dimension(53, 68));
                spriteContainer.setVisible(true);
                bob.add(spriteContainer);
            ...
            case 4:
                bob.removeAll();
                spriteContainer = new JLabel(new ImageIcon("src/tankjpg/blueBobleft.png"));
                spriteContainer.setPreferredSize(new Dimension(64, 60));
                bob.setPreferredSize(new Dimension(64, 60));
                spriteContainer.setVisible(true);
                bob.add(spriteContainer);
